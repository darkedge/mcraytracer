...
\begin{figure}
  \begin{tikzpicture}
    \draw[step=1cm,gray,very thin] (-7, 0) grid (8, 5);
    % hfov = 102.4478577779882556443232935315
    % TODO: calc/increase length
    \draw[very thick] (0.5, 0) -- ++(141.22392888899412782216164676575:3cm);
    \draw[very thick] (0.5, 0) -- ++(38.77607111100587217783835323425:3cm);
  \end{tikzpicture}
  \centering
