...
\begin{itemize}
  ...
  \item \texttt{RenderGlobal} \\
    ...
    The rest is handled automatically through inheritance.
\end{itemize}

% TODO: the basic concepts of render layers should be known at this point
\texttt{RaytracerRenderList} overrides \texttt{ChunkRenderContainer} such that the list of vertex buffers is sent to C++ instead of being drawn using OpenGL.
The \texttt{glBufferId} 
