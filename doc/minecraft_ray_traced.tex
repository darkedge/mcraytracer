...
\section{Hardware}
This project is developed on a Dell XPS 15 L502X with the following specifications:
\begin{itemize}
  \item Operating System: Microsoft Windows 10 Pro 64-bit% Version 1607 (Build 14393.447)
  \item Processor: Intel Core i7-2630QM
  \item Memory: 4 GB Dual-Channel DDR3 665MHz
  \item Graphics Processing Unit: NVIDIA GeForce GT 540M
  \begin{itemize}
    \item CUDA Cores: 96
    \item Shader Multiprocessors: 2
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    % eye point stuff
    \draw[dotted] (E) node[anchor=north west]{$S$} -- (F) node[anchor=north]{$O$};
  ...
  S& = \frac{Q + R}{2} \nonumber \\
  O& = S + \frac{\vec{u}}{\lvert\lvert\vec{u}\rvert\rvert}\bigcdot\frac{\lvert\lvert\overrightarrow{PR}\rvert\rvert}{2 \tan\left(\theta\right)} \label{eq:1}
  \end{align}
