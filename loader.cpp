...
#define RT_SET_VERTEX_BUFFER(name) void name(JNIEnv*, jint, jint, jint, jint, jint, jobject, jint)
...
(JNIEnv* env, jobject, jint id, jint x, jint y, jint z, jint layer, jobject obj, jint size) {
    g_raytracer.SetVertexBuffer(env, id, x, y, z, layer, obj, size);
}
